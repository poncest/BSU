...
shinyWidgets::pickerInput(
  ...
  choices  = unique(processed_data_tbl$bikeshop.name), 
  selected = unique(processed_data_tbl$bikeshop.name), 
  multiple = TRUE,
  options  = list(
    `actions-box` = TRUE,
    size = 10,
...
observedEvent(eventExpr = input$time_unit, {
...
observedEvent(eventExpr = input$forecast_mode, {
