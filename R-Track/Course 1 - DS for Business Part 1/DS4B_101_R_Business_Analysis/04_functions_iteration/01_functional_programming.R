...
# testing the separate_bike_model()
bike_tbl %>% 
    separate_bike_model()
...
# folder
fs::dir_create('R-Track/Course 1 - DS for Business Part 1/DS4B_101_R_Business_Analysis/00_scripts/')

# file
path <- 'R-Track/Course 1 - DS for Business Part 1/DS4B_101_R_Business_Analysis/00_scripts/separete_bikes_and_outlier_detection.R'
...
str_glue(
    "
# SEPARATE BIKE MODELS & DETECT OUTLIERS ----
    
# separate_bike_model(): A tidy function to separate the model column intro engineered features
    
# detect_outliers(): A vectorized function that detectsoutliers using TRUE/FALSE output
...
# remove
rm('separate_bike_model', 'detect_outliers')
